...
// #define LABEL_NALE_TXT_PATH "./model/zhu_8_labels_list.txt"

    static const char *labels[OBJ_CLASS_NUM] = {
        "Black_Ball", "Blue_Ball", "Blue_Placement_Zone", "Blue_Start_Zone", "Cross_Mark", "Red_Ball", "Red_Placement_Zone", "Red_Start_Zone", "Yellow_Ball"};

    // static const char *labels[OBJ_CLASS_NUM] = {
    //     "Blue_Zhu", "Black_Zhu", "Red_Zhu", "Green_Zhu", "Blue_Start_Zone", "Blue_Placement_Zone", "Red_Start_Zone", "Red_Placement_Zone"};
